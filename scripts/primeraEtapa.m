% Script para modelar un tramo de una pista de Fórmula 1 y las gradas
...
% Vector de variable independiente para graficar
t = 300: 0.001: 2800;

% Graficar radio de curvatura en distintos puntos de la curva
figure
plot(t, RadioCurvatura(P, t))
title('Radio de curvatura contra coordenada x')
xlabel('x (m)')
ylabel('Radio de curvatura')
ylim([0, 600])
yline(100, '-', 'R = 100 m')

% Graficar pista (polinomio P)
figure
plot(t, polyval(P,t))
title('Pista')
xlabel('x (m)')
...
% Marcar los extremos con * en la gráfica
...
p1 = 865.87;
R1 = RectaTangente(P,p1, [p1-100, p1+100]);
hold on
...
% Tangente al primer punto
p2 = 2421.7;
R2 = RectaTangente(P,p2, [p2-100, p2+100]);
hold on
